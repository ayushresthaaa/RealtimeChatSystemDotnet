...
{
    /// <inheritdoc />
    public partial class CreateStudentRecordSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleInstructor", x => new { x.ModuleId, x.InstructorId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleInstructor_Modules_ModuleId",
                        column: x => x.ModuleId,
